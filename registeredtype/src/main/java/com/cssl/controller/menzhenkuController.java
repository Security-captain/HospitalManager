...
import com.cssl.service.CTakeService;
...
public class menzhenkuController {
    ...
    @ResponseBody
    public Object selhuan(@RequestBody ReportVo reportVo,Integer page, Integer limit){

        System.out.println("registeredtype//查看患者信息");
        PageHelper.startPage(page, limit);
