...
import com.cssl.mapper.CCashierMapper;
...
public class CCashierServiceImpl implements CCashierService {
    ...
    //添加处方药品
    @Override
    public Integer addchu(CFTJ cftj) {
        return cCashierMapper.addchu(cftj);
    }
    //如果处方中含有该药品则修改数量和价钱
    @Override
    public Integer updchu(CFTJ cftj) {
        return cCashierMapper.updchu(cftj);
    }
    ...
    //删除处方中的药品
    @Override
    public Integer del(CFTJ cftj) {
        return cCashierMapper.del(cftj);
    }
    //减少药品中的数量
    @Override
    public Integer deldrunum(CFTJ cftj) {
        return  cCashierMapper.deldrunum(cftj);
    }
    //添加仓库中的数量
    @Override
    public Integer adddrunum(CFTJ cftj) {
        return cCashierMapper.adddrunum(cftj);
    }
    //模糊查询
    @Override
